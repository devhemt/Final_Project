    ...
    <div class="card info-card revenue-card">
        ...
        <div class="card-body">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                    <h6>${{$amount}}</h6>
                    <span class="{{$class}} small pt-1 fw-bold">{{number_format($percent, 2)}}%</span> <span class="text-muted small pt-2 ps-1">|| {{$status}} || <a href="{{url('admin/db/revenue/1')}}">See detail</a></span>
